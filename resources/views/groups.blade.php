...
@section('content')
<div class="flex h-screen w-screen" x-data="groupsPage()">
    <!-- Sidebar -->
            ...
            <div class="px-4 space-y-2">
                ...
                <div class="relative">
                    ...
                    <div x-show="contactsOpen && sidebarOpen" 
                        ...
                        <a href="{{ route('groups') }}" class="flex items-center space-x-3 p-2 rounded-lg bg-green-600/50 text-white group">
            ...
            <div class="flex items-center justify-between px-6 py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Manage your contact groups</p>
                    </div>
                </div>
            ...
            <div class="bg-white/80 backdrop-blur-md rounded-xl shadow-xl border border-white/20">
                ...
                <div class="p-6 border-b border-gray-200/50">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <h2 class="text-xl font-bold text-gray-900">Group Management</h2>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-gray-50/50 backdrop-blur-sm border-b border-gray-200/50">
                            <tr>
                                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Group Name</th>
                        ...
                        <tbody class="bg-white/30 backdrop-blur-sm divide-y divide-gray-200/50">
                            ...
                            <tr x-show="loading">
                                <td colspan="2" class="px-6 py-12 text-center text-gray-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-lg font-medium">Loading groups...</p>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr x-show="error && !loading">
                                <td colspan="2" class="px-6 py-12 text-center text-red-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <button @click="fetchGroups()" class="mt-4 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors">
                                            Try Again
                                        </button>
                                    </div>
                                </td>
                            ...
                            <template x-for="group in paginatedGroups" :key="group.id">
                                <tr x-show="!loading && !error" class="hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="text-sm font-medium text-gray-900" x-text="group.group_name"></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                            ...
                            <!-- No groups state -->
                            <tr x-show="!loading && !error && filteredGroups.length === 0">
                                <td colspan="2" class="px-6 py-12 text-center text-gray-500">
                                    <div class="flex flex-col items-center">
                                        <i class="fas fa-users text-4xl text-gray-300 mb-4"></i>
                                        <p class="text-lg font-medium">No groups found</p>
                                        <p class="text-sm">Try adding a new group</p>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="px-6 py-4 border-t border-gray-200/50 bg-gray-50/30 backdrop-blur-sm">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            Showing <span class="font-medium" x-text="startIndex + 1"></span> to <span class="font-medium" x-text="Math.min(endIndex, filteredGroups.length)"></span> of <span class="font-medium" x-text="filteredGroups.length"></span> results
                        </div>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-4">
                                <label for="editGroupName" class="block text-sm font-medium text-gray-700">Group Name</label>
                                <input type="text" 
                                       id="editGroupName" 
                                       x-model="editingGroup.group_name" 
                                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                            </div>
                        </div>
                    </div>
        ...
        async updateGroup() {
            if (this.editingGroup.group_name.trim() !== '') {
                try {
                    ...
                    const data = await response.json();
                    console.log('Update group response:', data); // Debug API response
