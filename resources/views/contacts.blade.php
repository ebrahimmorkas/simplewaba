...
@section('content')
<div class="flex h-screen w-screen" x-data="contactsPage()">
    <!-- Sidebar -->
            ...
            <div class="px-4 space-y-2">
                ...
                <div class="relative">
                    ...
                    <div x-show="contactsOpen && sidebarOpen" 
                        ...
                        <a href="{{ route('contacts') }}" class="flex items-center space-x-3 p-2 rounded-lg bg-green-600/50 text-white group">
            ...
            <div class="flex items-center justify-between px-6 py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Manage your contacts and groups</p>
                    </div>
                </div>
            ...
            <div class="bg-white/80 backdrop-blur-md rounded-xl shadow-xl border border-white/20">
                ...
                <div class="p-6 border-b border-gray-200/50">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        <h2 class="text-xl font-bold text-gray-900">Contact Management</h2>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <div class="flex gap-2">
                                <!-- Add New Contact -->
                                <button @click="addNewContact()" class="px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 transition-all shadow-md hover:shadow-lg">
                                    <i class="fas fa-plus mr-2"></i>
                                    Add New Contact
                                </button>
                                
                                <!-- Import -->
                                <button class="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all shadow-md hover:shadow-lg">
                                ...
                                <div x-data="{ exportOpen: false }" class="relative">
                                    <button @click="exportOpen = !exportOpen" 
                                            class="px-4 py-2 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-lg hover:from-purple-600 hover:to-purple-700 transition-all shadow-md hover:shadow-lg flex items-center">
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50/50 backdrop-blur-sm border-b border-gray-200/50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Mobile</th>
                                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Group</th>
                                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider hidden lg:table-cell">Tags</th>
                ...
                <div class="px-6 py-4 border-t border-gray-200/50 bg-gray-50/30 backdrop-blur-sm">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            Showing <span class="font-medium" x-text="startIndex + 1"></span> to <span class="font-medium" x-text="Math.min(endIndex, filteredContacts.length)"></span> of <span class="font-medium" x-text="filteredContacts.length"></span> results
                        </div>
            ...
            <div @click.away="showContactModal = false" 
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">
                                <span x-text="isEditing ? 'Edit Contact' : 'Add New Contact'"></span>
                            </h3>
                            <div class="mt-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           id="contactName" 
                                           x-model="editingContact.name" 
                                           class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                                </div>
                                
                                <!-- Mobile -->
                                <div>
                                    <label for="contactMobile" class="block text-sm font-medium text-gray-700">Mobile</label>
                                    <input type="text" 
                                           id="contactMobile" 
                                           x-model="editingContact.mobile" 
                                           class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                                </div>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button @click="saveContact()" 
                        ...
                        <span x-text="isEditing ? 'Update Contact' : 'Add Contact'"></span>
                    </button>
    ...
    <div x-show="showTagsModal" 
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div @click.away="showTagsModal = false" 
                 class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">
                                Manage Tags for <span x-text="editingContact.name" class="font-bold"></span>
                            </h3>
                            <div class="mt-4">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button @click="updateContactTags()" 
                            class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm">
                        Save Tags
                    </button>
